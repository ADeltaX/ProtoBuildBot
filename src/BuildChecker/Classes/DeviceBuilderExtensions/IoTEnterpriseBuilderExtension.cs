...
{
    public sealed class IoTEnterpriseBuilderExtension : BuilderExtension
    {
        public IoTEnterpriseBuilderExtension(string Branch, string Build, string Arch, string Flight, string Ring)
            : base(Branch, Build, Arch, Flight, Ring, "188")
        { }
